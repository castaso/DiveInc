...
module.exports = (sequelize, DataTypes) => {
  var Model = sequelize.define('transaction_resort', {
    transaction_resort_status_id: DataTypes.UUID,
    transaction_code: DataTypes.TEXT,
    customer_id: DataTypes.UUID,
    resort_id: DataTypes.UUID,
    ...
    tableName : 'transaction_resorts',
    underscored: true,
  });
  Model.associate = function(models) {
    Model.belongsTo(models.transaction_resort_status, { foreignKey: 'transaction_resort_status_id'});
    Model.belongsTo(models.resort, { foreignKey: 'resort_id'});
  };
  return Model;
};
