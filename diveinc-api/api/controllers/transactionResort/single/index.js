...
controller.put(`/schedule`,middleware.checkToken, async (req,res) => {
  ...
  paramData.transaction_resort_status_id = 'd2f95bbe-159b-4447-9e07-33925e04c5e9'
...
controller.put(`/extra`,middleware.checkToken, async (req,res) => {
  ...
  var paramData = {}
  paramData.package_data = package_data
  paramData.transaction_resort_status_id = '59cfbb65-efff-4d25-aae1-b439efa62188'
...
controller.put(`/guest`, middleware.checkToken, async (req,res) => {
  ...
  var paramData = {}
  paramData.package_data = package_data
  paramData.transaction_resort_status_id = 'b648ff73-468f-45cb-bbbc-fd3659e4b8ac'
  ...
  let sendEmail = await template.emailResortRequestForUser(checkUpdate.dataValues)
  mailService(sendEmail)

  let sendEmail2 = await template.emailResortRequestForVendor(checkUpdate.dataValues)
...
controller.put(`/approve`, middleware.checkToken, async (req,res) => {
  ...
  getData.dataValues.type = "Resort"
  // Panggil Xendit
  console.log("++++++++++++++++++++++++++++++++++++++++++++++++++++")
  //Fungsi XENDIT
  ...
  var paramData = {}
  paramData.transaction_resort_status_id = 'bbb8ff73-468f-45cb-babc-fd3444e4b8ac'
  paramData.total_price = loadTotal(getData.dataValues)
  paramData.diveinc_fee = {
    percent : generalData.resort_fee,
    task : 10,
...
controller.put(`/reject`, middleware.checkToken, async (req,res) => {
  ...
  var paramData = {}
  paramData.transaction_resort_status_id = 'bcc8ff73-468f-45cb-babc-fd34cce4b8ac'
  ...
  //console.log(checkUpdate.dataValues)
  let sendEmail = await template.emailResortRejected(checkUpdate.dataValues)
  mailService(sendEmail)
...
controller.put(`/cancel`, middleware.checkToken, async (req,res) => {
  ...
  var paramData = {}
  // paramData.package_data = package_data
  paramData.transaction_resort_status_id = 'baa8ff37-468f-455b-b5c5-fc34aae4b8ac'
  ...
  let sendEmail = await template.emailCancelResort(checkUpdate.dataValues, checkUpdate.dataValues.resort.dataValues.user.dataValues.data_register.data.email)
  mailService(sendEmail)
