...
const mainModel = require('@models').contribution
...
controller.get(`/`, async (req,res) => {
  ...
  getData.dataValues.user = {
    id : dataUser.dataValues.id,
    profile : {
      name : dataUser.dataValues.profile.name,
      picture : dataUser.dataValues.profile.picture
    },
    created_at : dataUser.dataValues.created_at
  }
...
controller.put(`/document`, middleware.checkToken, async (req,res) => {
