...
const model = 'room_aminity'
const table = 'room_aminities'
...
const mainModel = require('@models').room_aminity
...
controller.put(`/`, middleware.checkToken, async (req,res) => {
  ...
  if(!name || !description) return res.status(403).send({success: false, message: "Invalid body"})
