...
module.exports = {
    datatable : async (req,res,next) => {
        ...
        let result = await axios.call(`v1/transaction-wallet-admin/datatable`, `GET`, null, cookie.accessToken, null, req._parsedUrl.query)
        ...
        for(var i = 0; i < result.data.data.length; i++){
            ...
            if(result.data.data[i].transaction_wallet_status.name == "Request"){
                oneData.push(`
                <a href="#" onclick="accept('${result.data.data[i].id}');">Full</a>`+
                `<a onclick="partialPayment('${result.data.data[i].id}','${result.data.data[i].user_data.balance}');">Partial</a>`+
    ...
    getAll : async (req,res,next) => {
        ...
        let result = await axios.call(`v1/transaction-wallet-admin`, `GET`, null, cookie.accessToken, null, req._parsedUrl.query)
    ...
    getById : async (req,res,next) => {
        ...
        let result = await axios.call(`v1/transaction-wallet-admin`, `GET`, null, cookie.accessToken, req.params.id, req._parsedUrl.query)
    ...
    add : async (req,res,next) => {
        ...
        let result = await axios.call(`v1/transaction-wallet-admin`, `POST`, req.body, cookie.accessToken, null, req._parsedUrl.query)
    ...
    update : async (req,res,next) => {
        ...
        let result = await axios.call(`v1/transaction-wallet-admin`, `PUT`, req.body, cookie.accessToken, req.params.id, req._parsedUrl.query)
    ...
    delete : async (req,res,next) => {
        ...
        let result = await axios.call(`v1/transaction-wallet-admin`, `DELETE`, null, cookie.accessToken, req.params.id, req._parsedUrl.query)
    ...
    accept : async (req,res,next) => {
        ...
        let result = await axios.call(`v1/transaction-wallet-admin/${req.params.id}/accept`, `PUT`, null, cookie.accessToken, null, req._parsedUrl.query)

        if(!result.data.message) return res.status(500).send({success : false, message : `Internal server error`})
        res.status(result.status).send(result.data)
    },
    acceptPartial : async (req,res,next) => {

        var cookie = parseCookies(req)

        let result = await axios.call(`v1/transaction-wallet-admin/${req.params.id}/accept-partial`, `PUT`, req.body, cookie.accessToken, null, req._parsedUrl.query)
